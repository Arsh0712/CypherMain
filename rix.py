...
class PaginationView(discord.ui.View):
    ...
    @discord.ui.button(emoji="<:MekoDoubleArrowLeft:1302274910856413316>", style=discord.ButtonStyle.blurple, disabled=False)
    async def first(self, interaction: discord.Interaction, button: discord.ui.Button):
        self.current = 0
    ...
    @discord.ui.button(emoji="<:MekoTrash:1302929643514499114>", style=discord.ButtonStyle.red)
    async def stop(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.message.delete()
        self.stop()

    @discord.ui.button(emoji="<:MekoArrowRight:1302273350743097395>", style=discord.ButtonStyle.green, disabled=False)
    async def next(self, interaction: discord.Interaction, button: discord.ui.Button):
        self.current += 1
    ...
    @discord.ui.button(emoji="<:MekoDoubleArrowRight:1302274914325106730>", style=discord.ButtonStyle.blurple, disabled=False)
