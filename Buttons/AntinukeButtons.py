...
class TrashButton(discord.ui.Button):
    def __init__(self, author_id):
        super().__init__(emoji="<:MekoTrash:1302929643514499114>", style=discord.ButtonStyle.gray)
        self.author_id = author_id
    
    async def callback(self, interaction: discord.Interaction):
        if interaction.user.id != self.author_id:
            await interaction.response.send_message(embed=discord.Embed(description=f"<:MekoExclamation:1302243537924132875> {interaction.user.mention}: Oops! Sorry, but you can't interact with these buttons this is only for <@{self.author_id}>", color=0xFFFFFF ),ephemeral=True)
            return
        await interaction.message.delete()

class SupportButton(discord.ui.Button):
    def __init__(self):
        super().__init__(label="Need Help? Join Support Server", style=discord.ButtonStyle.url, url="https://discord.gg/XBbHRYg4ZW")
...
class Buttons(discord.ui.View):
    ...
    async def interaction_check(self, interaction: discord.Interaction) -> bool:
        if interaction.user.id != self.author_id:
            await interaction.response.send_message(embed=discord.Embed(description=f"<:MekoExclamation:1302243537924132875> {interaction.user.mention}: Oops! Sorry, but you can't interact with these buttons this is only for <@{self.author_id}>", color=0xFEE75C ),ephemeral=True)
            return False
        return True

    @discord.ui.button(emoji="<:WhitelistUser:1101346593493491732>", label="Whitelisted Users", style=discord.ButtonStyle.grey, row=0)
    ...
    @discord.ui.button(emoji="<:MekoBan:1302243547780743199> ", label="Antinuke Punishment", style=discord.ButtonStyle.grey, row=0)
...
class PunishmentView(View):
    ...
    async def kick_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        try:
            ...
            embed = discord.Embed(
                    description=f"<:tick_icons:1154295677149519894> {interaction.user.mention}: Punishment for this server has been set to **`Kick`**.",
                    color=0xFFFFFF)
    ...
    async def ban_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        try:
            ...
            embed = discord.Embed(
                    description=f"<:tick_icons:1154295677149519894> {interaction.user.mention}: Punishment for this server has been set to **`Ban`**.",
                    color=0xFFFFFF)
            embed.set_author(name=interaction.guild.name, icon_url=interaction.guild.icon.url if interaction.guild.icon else None)
            embed.set_footer(text=f"Requested By {interaction.user.name}", icon_url=interaction.user.display_avatar.url)
            await interaction.response.edit_message(embed=embed,view=self.replace_with_trash_button()
    ...
    async def none_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        try:
            ...
            embed = discord.Embed(
                    description=f"<:tick_icons:1154295677149519894> {interaction.user.mention}: Punishment for this server has been set to **`Strip`**.",
                    color=0xFFFFFF)
            embed.set_author(name=interaction.guild.name, icon_url=interaction.guild.icon.url if interaction.guild.icon else None)
            embed.set_footer(text=f"Requested By {interaction.user.name}", icon_url=interaction.user.display_avatar.url)
            await interaction.response.edit_message(embed=embed,view=self.replace_with_trash_button()
...
class AntibanButtons(discord.ui.View):
    ...
    @discord.ui.button(emoji="<:MekoTrash:1302929643514499114>", style=discord.ButtonStyle.grey)
...
class AntiPingButtons(discord.ui.View):
    ...
    async def interaction_check(self, interaction: discord.Interaction) -> bool:
        if interaction.user.id != self.author_id:
            await interaction.response.send_message(embed=discord.Embed(description=f"<:icons_info:1354798914548666589> {interaction.user.mention}: Oops! Sorry, but you can't interact with these buttons this is only for <@{self.author_id}>", color=0xFEE75C ),ephemeral=True)
            return False
        return True
    ...
    async def callback(self, interaction: discord.Interaction):
        if interaction.user.id == self.author_id:
            ...
            embed1 = discord.Embed(
                ...
                description=f"""
                > **Anti Ban:** <:enable:1264303466461794385>
                > **Anti Kick:** <:enable:1264303466461794385>
                > **Anti Prune:** <:enable:1264303466461794385>
                > **Anti Bot:** <:enable:1264303466461794385>
                > **Anti Channel Create:** <:enable:1264303466461794385>
                > **Anti Channel Delete:** <:enable:1264303466461794385>
                > **Anti Channel Update:** <:enable:1264303466461794385>
                > **Anti Role Create:** <:enable:1264303466461794385>
                > **Anti Role Delete:** <:enable:1264303466461794385>
                > **Anti Role Update:** <:enable:1264303466461794385>
                > **Anti Emoji Create:** <:enable:1264303466461794385>
                > **Anti Emoji Delete:** <:enable:1264303466461794385>
                > **Anti Emoji Update:** <:enable:1264303466461794385>
                > **Anti Sticker Create:** <:enable:1264303466461794385>
                > **Anti Sticker Delete:** <:enable:1264303466461794385>
                > **Anti Sticker Update:** <:enable:1264303466461794385>
                > **Anti Webhook Create:** <:enable:1264303466461794385>
                > **Anti Webhook Delete:** <:enable:1264303466461794385>
                > **Anti Everyone/Here Mention:** <:enable:1264303466461794385>""",
                color=color)
            embed1.set_author(
...
class ThresholdModal(Modal):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        try:
            ...
            color = 0xFFFFFF
            embed = discord.Embed(
                description=f"<:tick_icons:1154295677149519894>{interaction.user.mention} Threshold has been set to **`{threshold}`** for **`{self.option}`**",
                color=color
            )
            embed.set_author(name=interaction.guild.name,
                             icon_url=interaction.guild.icon.url if interaction.guild.icon else None)
...
class DeleteButton(Button):
    def __init__(self):
        super().__init__(emoji="<:MekoTrash:1302929643514499114>", style=discord.ButtonStyle.danger)
...
class SupportServerButton(Button):
    def __init__(self):
        super().__init__(label="Support Server", url="https://discord.gg/XBbHRYg4ZW", style=discord.ButtonStyle.link)


class BackButton(Button):
    def __init__(self, original_embed, original_view):
        super().__init__(emoji="<:green_arrow:1263757244131180661>", style=discord.ButtonStyle.blurple)
        self.original_embed = original_embed
        self.original_view = original_view
    ...
    async def callback(self, interaction: discord.Interaction):
        if interaction.user.id == self.author_id:
            ...
            embed9 = discord.Embed(
                title="\n<:info:1323668476006760460>**__Extra Info__**",
...
class ChannelSelectorView(discord.ui.View):  
    def __init__(self, ctx):
        ...
        delete_button = discord.ui.Button(emoji="<:MekoTrash:1302929643514499114>", style=discord.ButtonStyle.danger)
        delete_button.callback = self.delete_callback
        self.add_item(delete_button)

        back_button = discord.ui.Button(emoji="<:green_arrow:1263757244131180661>", style=discord.ButtonStyle.gray)
    ...
    async def channel_select_callback(self, interaction: discord.Interaction):
        ...
        color = 0xFFFFFF
        embed = discord.Embed(
            description=f"<:info:1323668476006760460> Moderation loggings channel has been set to <#{selected_channel}>",
            color=color
        )
        embed.set_author(name=interaction.guild.name, icon_url=interaction.guild.icon.url if interaction.guild.icon else None)
        embed.set_footer(text=f"Requested By {interaction.user.display_name}", icon_url=interaction.user.display_avatar.url)
    ...
    async def reset_callback(self, interaction: discord.Interaction):
        ...
        color = 0xFFFFFF 
        embed = discord.Embed(
            description="<:tick_icons:1154295677149519894>Moderation loggings channel has been set to `None`",
            color=color
        )
        embed.set_author(name=interaction.guild.name, icon_url=interaction.guild.icon.url if interaction.guild.icon else None)
        embed.set_footer(text=f"Requested By {interaction.user.display_name}", icon_url=interaction.user.display_avatar.url)
    ...
    async def back_callback(self, interaction: discord.Interaction):
        ...
        b2 = discord.ui.Button(label="Need Help? Join Support Server", style=discord.ButtonStyle.url, url="https://discord.gg/XBbHRYg4ZW")
...
class GuildSelectorView(discord.ui.View):  
    ...
    async def channel_select_callback(self, interaction: discord.Interaction):
        ...
        color = 0xFFFFFF
        embed = discord.Embed(
            description=f"<:info:1323668476006760460> Guild loggings channel has been set to <#{selected_channel}>",
            color=color
        )
        embed.set_author(name=interaction.guild.name,
                        icon_url=interaction.guild.icon.url if interaction.guild.icon else None)
    ...
    async def reset_callback(self, interaction: discord.Interaction):
        ...
        color = 0xFFFFFF  
        embed = discord.Embed(
            description="<:tick_icons:1154295677149519894>Guild loggings channel has been set to `None`",
            color=color
        )
        embed.set_author(name=interaction.guild.name,
                        icon_url=interaction.guild.icon.url if interaction.guild.icon else None)
...
class RoleSelectorView(discord.ui.View):  
    ...
    async def channel_select_callback(self, interaction: discord.Interaction):
        ...
        color = 0xFFFFFF  
        embed = discord.Embed(
            description=f"<:info:1323668476006760460> Role loggings channel has been set to <#{selected_channel}>",
            color=color
        )
        embed.set_author(name=interaction.guild.name,
                        icon_url=interaction.guild.icon.url if interaction.guild.icon else None)
    ...
    async def reset_callback(self, interaction: discord.Interaction):
        ...
        color = 0xFFFFFF
        embed = discord.Embed(
            description="<:tick_icons:1154295677149519894>Role loggings channel has been set to `None`",
            color=color
        )
        embed.set_author(name=interaction.guild.name,
                        icon_url=interaction.guild.icon.url if interaction.guild.icon else None)
