...
class MenuView(discord.ui.View):
    ...
    async def developer_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        try:
            ...
            status_emojis = {
                discord.Status.online: "<:online:1303311389581901845>",
                discord.Status.idle: "<:idle:1303311418602557500>",
                discord.Status.dnd: "<:dnd:1303311360418906122>",
                discord.Status.offline: "<:offline:1303311483584778313>",
            }
            ...
            if dev1:
                ...
                dev1_status = "<:offline:1303311483584778313> Offline"
            ...
            if dev2:
                ...
                dev2_status = "<:offline:1303311483584778313> Offline"
            ...
            if dev3:
                ...
                dev3_status = "<:offline:1303311483584778313> Offline"
            
            embed = discord.Embed(colour=0x2b2d31, description=f"<:MekoArrowRight:1302273350743097395> Below Is The Information Regarding The Bot's Owner, Developer, And Team Members.\n\n<:MekoDeveloper:1303313515716677662> **Owner & Developers**\n`1.` [`DarkNighT`](https://discordapp.com/users/919147106684510249)\n**<:icon_status:1303314423359733850> Status :** {dev1_status}\n**<:MekoActivity:1303312633486770196> Activity :** {dev1_activity}\n\n`2.` [`Hecronn`](https://discordapp.com/users/919175804829708308)\n**<:icon_status:1303314423359733850> Status :** {dev2_status}\n**<:MekoActivity:1303312633486770196> Activity :** {dev2_activity}\n\n`3.` [`fugitive`](https://discordapp.com/users/1295700461663289419)\n**<:icon_status:1303314423359733850> Status :** {dev3_status}\n**<:MekoActivity:1303312633486770196> Activity :** {dev3_activity}\n\n\n**<a:MekoLove:1303235997399646208>Credits**\n`1.` [`iyad`](https://discordapp.com/users/1041381818273906799) & [`Console`](https://discordapp.com/users/687482572703662108) **[** Emoji Credits **]**\n`2.` [`Glaxin`](https://discordapp.com/users/620569922870837253) **[** Web Developer **]**\n`3.` [`None`](https://discordapp.com/users/) **[** Contributors **]**")
    ...
    async def links_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        try:
            ...
            embed.description="<:Team:1268929484002689135> [**Support Server**](https://discord.gg/cV6nHTfzNq)\nFeel free to click on the `Support Server` link and join our community for any assistance you may need.\n\n<:MekoInvite:1268929677108445205> [**Bot Invite**](https://discordapp.com/oauth2/authorize?client_id=1191399940014997584&scope=bot+applications.commands&permissions=8)\nClick on the `Bot Invite` button to invite the Cypher bot to any of your servers.\n\n<:MekoTopgg:1302243523441066034> [**Vote on top.gg**](https://top.gg/bot/1191399940014997584/vote)\nClick on the `Vote On Top.gg` option and kindly cast your valuable vote for the incredible Cypher."
    ...
    @discord.ui.button(emoji="<:MekoHome:1302242770672418886>", style=discord.ButtonStyle.danger)
    async def home_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        try:
            ...
            prefix = data["prefix"]
            embed = discord.Embed(colour=0x2b2d31)
            embed.description=f"<a:MekoLove:1303235997399646208> Hey {interaction.user.mention},\n<:MekoPrefix:1303236683591974963> Prefix For This Server is `{prefix}`\n\nType `{prefix}help` for more information."
    ...
    async def on_message(self, message):
        ...
        if self.bot.user in message.mentions:
            if len(message.content.strip().split()) == 1:
                ...
                embed = discord.Embed(
                        description=(
                            f"<a:MekoLove:1303235997399646208> Hey {message.author.mention},\n"
                            f"<:MekoPrefix:1303236683591974963> Prefix For This Server is `{prefix}`\n\n"
