...
class VariableButton(Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        embed = discord.Embed(
            description="**The args which can you use in welcome message**\nUse these placeholders in your welcome message:",
...
class Welcomer(commands.Cog):
    ...
    async def _create_table(self):
        async with aiosqlite.connect("database/welcome.db") as db:
            await db.execute("""
    ...
    @commands.group(invoke_without_command=True, name="greet", help="Shows all the greet commands.")
    @blacklist_check()
    @ignore_check()
    ...
    async def greet_setup(self, ctx):
        ...
        embed.add_field(
            name="<:MekoArrowRight:1302273350743097395> Simple",
            value="Send a plain text welcome message. You can use placeholders to personalize it.\n\n",
            inline=False
        )
        embed.add_field(
            name="<:MekoArrowRight:1302273350743097395> Embed",
    ...
    async def simple_setup(self, ctx):
        ...
        async def submit_callback(interaction):
            ...
            if message_content:
                ...
                await interaction.response.send_message("<a:H_TICK:1302972336039006229> Welcome message setup completed!")
        ...
        cancel_button = Button(emoji="<:MekoTrash:1302929643514499114>", style=discord.ButtonStyle.secondary)
    ...
    color=discord.Color(embed_data["color"]) if embed_data["color"] else discord.Color(0x2f3136)
        ...
        async def submit_callback(interaction):
            ...
            await interaction.response.send_message("<a:H_TICK:1302972336039006229> Embed welcome message setup completed!")
    ...
    async def greet_reset(self, ctx):
        ...
        async def yes_button_callback(interaction):
            ...
            embed.title = "<a:H_TICK:1302972336039006229>Success"
    ...
    async def greet_channel(self, ctx):
        ...
        def generate_view(page):
            select_menu = Select(
                ...
                options=[
                    discord.SelectOption(label=channel.name, emoji="<:MekoChannel:1302243558748717057>", value=str(channel.id))
            ...
            async def select_callback(interaction: discord.Interaction):
                ...
                await ctx.send(f"<a:H_TICK:1302972336039006229> Welcome channel has been set to {selected_channel.mention}")
    ...
    async def greet_autodelete(self, ctx, time: str):
        ...
        await ctx.send(f"<a:H_TICK:1302972336039006229> Auto delete duration has been set to **{auto_delete_duration}** seconds.")
