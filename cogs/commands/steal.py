            ...
            if not emojis:
                ...
                async def get_view(disabled=False):
                    ...
                    stop_button = discord.ui.Button(
                        ...
                        emoji="<:MekoTrash:1302929643514499114>",
                        row=1
                    )
                ...
                async def add_as_emoji_button_callback(interaction:discord.Interaction):
                    try:
                        ...
                        added = True
                        added_title = f"<:WickTick:1324739295319298130> - Emojis Added"
                ...
                async def add_as_emoji_button_callback(interaction:discord.Interaction):
                    try:
                        ...
                        nonlocal added,added_title
                        added = True
                        added_title = f"<a:H_TICK:1302972336039006229> - Emojis Added"
                ...
                async def add_as_sticker_button_callback(interaction:discord.Interaction):
                    try:
                        ...
                        nonlocal added,added_title
                        added = True
                        added_title = f"<a:H_TICK:1302972336039006229> - Stickers Added"
