...
class Blacklist(commands.Cog):
  ...
  async def set_db(self):
    async with aiosqlite.connect('database/block.db') as db:
        await db.execute('''
  ...
  async def add_user(self, ctx, user: discord.User):
    async with aiosqlite.connect('database/block.db') as db:
      ...
      if await cursor.fetchone():
        embed = discord.Embed(
          description=f"<:MekoExclamation:1302243537924132875> {user.mention} is already blacklisted.",
          color=0x000000
        )
        ...
        await db.commit()
        embed = discord.Embed(
          description=f"<a:H_TICK:1302972336039006229> {user.mention} has been added to the blacklist.",
          color=0x000000
        )
        await ctx.reply(embed=embed)
  ...
  async def remove_user(self, ctx, user: discord.User):
    async with aiosqlite.connect('database/block.db') as db:
      ...
      if not await cursor.fetchone():
        embed = discord.Embed(
          description=f"<a:MekoCross:1302972393572143125> {user.mention} is not in the blacklist.",
          color=0x000000
        )
        await ctx.reply(embed=embed)
      else:
        ...
        await db.commit()
        embed = discord.Embed(
          description=f"<a:H_TICK:1302972336039006229> {user.mention} has been removed from the blacklist.",
          color=0x000000
        )
        await ctx.reply(embed=embed)
  ...
  async def show_users(self, ctx):
    async with aiosqlite.connect('database/block.db') as db:
      ...
      if not rows:
        embed = discord.Embed(
          description="<a:MekoCross:1302972393572143125> There are no users in the blacklist.",
          color=0x000000
        )
        await ctx.reply(embed=embed)
        return
  ...
  async def add_guild(self, ctx, guild_id: int):
    async with aiosqlite.connect('database/block.db') as db:
      ...
      if await cursor.fetchone():
        embed = discord.Embed(
          title="<a:MekoCross:1302972393572143125> Guild Already Blacklisted",
        ...
        embed = discord.Embed(
          title="<a:H_TICK:1302972336039006229> Guild Blacklisted",
  ...
  async def remove_guild(self, ctx, guild_id: int):
    async with aiosqlite.connect('database/block.db') as db:
      ...
      if not await cursor.fetchone():
        embed = discord.Embed(
          title="<a:MekoCross:1302972393572143125> Guild Not Blacklisted",
        ...
        await db.commit()
        embed = discord.Embed(
          title="<a:H_TICK:1302972336039006229> Guild Unblacklisted",
  ...
  async def show_guilds(self, ctx):
    async with aiosqlite.connect('database/block.db') as db:
      ...
      if not rows:
        embed = discord.Embed(
          title="<a:MekoCross:1302972393572143125> No Blacklisted Guilds",
  ...
  async def on_guild_join(self, guild):
    """Prevents bot from joining blacklisted guilds."""
    async with aiosqlite.connect('database/block.db') as db:
