...
Aliases""")
  ...
  async def membercount(self, ctx: commands.Context):
    ...
    embed.description=(
            f"> <:MekoArrowRight:1302273350743097395> Total Members: {len(ctx.guild.members)}\n"
            f"> <:bot_icon:1309451432042299423> Bots: {bots}\n"
            f"> <:online:1303311389581901845> Online: {online}\n"
            f"> <:offline:1303311483584778313> Offline: {offline}\n"
            f"> <:idle:1303311418602557500> Idle: {idle}\n"
            f"> <:dnd:1303311360418906122> Do Not Disturb: {dnd}\n"
            )
