...
class Fun(commands.Cog):
    ...
    async def tickle(self, ctx, user: discord.Member = None):
         if user is None:
            embed = discord.Embed()
            embed.description = "<:MekoExclamation:1302243537924132875> Mention a user to use this command."
  ...
  '40', '45', '80', '100', '150', '1000', '5000', '10000', '999999',
    ...
    async def Sigma(self, ctx, *, person):
        ...
        embed.description = f'**{person} is {random.choice(responses)}% Sigma** <a:sigma:1310224743038713896> '
    ...
    async def pickupline(self, ctx: Context) -> None:
        ...
        embed = discord.Embed(
            title="<:rizz:1310225237677441038> Your pickup line <:rizz:1310225237677441038>",
