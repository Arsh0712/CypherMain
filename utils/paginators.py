    ...
    async def format_page(self, menu: HackerPaginator,
        ...
        if maximum > 1:
            ...
            self.embed.set_footer(
                text=text,
                icon_url=
                "https://images-ext-1.discordapp.net/external/pPcdpBEwWvRCqCdOm6J2TKol6dD71eDN9w19AXFqTZU/%3Fsize%3D1024/https/cdn.discordapp.com/avatars/1291108140544295004/a_590209db795bc891fb04b8f937b293b3.gif?width=676&height=676"
            )
...
class DescriptionEmbedPaginator(menus.ListPageSource):
    ...
    async def format_page(self, menu: HackerPaginator,
        ...
        maximum = self.get_max_pages()
        if maximum > 1:
            self.embed.title = f"\n<:MekoLogs:1302243574225830019> Page : `{menu.current_page + 1}/{maximum}`"
