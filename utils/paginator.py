...
class Paginator(discord.ui.View):
    ...
    def update_styles(self, **kwargs):
        ...
        self.first_page_button.emoji = kwargs.get('first_button_emoji') or '<:MekoDoubleArrowLeft:1302274910856413316>'
        self.previous_page_button.emoji = kwargs.get(
            'previous_button_emoji') or '<:MekoArrowLeft:1302273353507405854>'
        self.next_page_button.emoji = kwargs.get('next_button_emoji') or '<:MekoArrowRight:1302273350743097395>'
        self.last_page_button.emoji = kwargs.get('last_button_emoji') or '<:MekoDoubleArrowRight:1302274914325106730>'
        self.stop_button.emoji = kwargs.get(
            'stop_button_emoji') or '<a:MekoCross:1302972393572143125>'
